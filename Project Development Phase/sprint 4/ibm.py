...
Original file is located at
    https://colab.research.google.com/drive/131tRkJ9UtBOL5bnReiZP-Snik7OiiOAF
"""
...
API_KEY = "CF4MPFboywxf02sUFxOVZRxmy2mJbg5ug3DZum9XPb1d"
...
app = Flask(__name__, template_folder="/content/app.py")

@app.route('/', methods=['GET'])
def index():
    return render_template('/content/home.html.htmlhome.html')


@app.route('/home', methods=['GET'])
def about():
    return render_template('/content/home.html.html')
